            ...
            <div className="d-flex flex-column justify-content-center align-items-center mt-5">
                {
                    items.map(card => {
                        ...
                        return <Card title={card.title} deadline={card.deadline} marketValue={card.marketValue} median={card.median} value={card.value} oportunity={card.oportunity} img={card.img.img} key={card.title}/>
